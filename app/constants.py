...
SHOP_ITEMS = {
    1:  {"name": "🍎 Яблоко",               "price": 5,    "desc": "Приятный перекус. +настроение",                  "rarity": "common",    "category": "food",      "usable": True,  "passive": False},
    2:  {"name": "🌹 Роза",                 "price": 20,   "desc": "Подари кому-то (+5 XP получателю)",             "rarity": "common",    "category": "social",    "usable": True,  "passive": False},
    3:  {"name": "🎁 Подарок",              "price": 50,   "desc": "Рандомный сюрприз: 10-100 монет",               "rarity": "common",    "category": "economy",   "usable": True,  "passive": False},
    4:  {"name": "🧸 Плюшевый мишка",       "price": 100,  "desc": "+10 XP при покупке",                           "rarity": "common",    "category": "social",    "usable": True,  "passive": False},
    5:  {"name": "💊 Зелье здоровья",       "price": 30,   "desc": "+15 XP при использовании",                     "rarity": "common",    "category": "xp",        "usable": True,  "passive": False},
    6:  {"name": "🎫 Лотерейный билет",     "price": 25,   "desc": "30% шанс выиграть 100 монет",                  "rarity": "common",    "category": "economy",   "usable": True,  "passive": False},
    7:  {"name": "📜 Свиток опыта",         "price": 100,  "desc": "+50 XP при использовании",                     "rarity": "uncommon",  "category": "xp",        "usable": True,  "passive": False},
    8:  {"name": "🍀 Четырёхлистный клевер", "price": 150,  "desc": "+10% удачи в /slots (пассивно)",               "rarity": "uncommon",  "category": "slots",     "usable": True,  "passive": True},
    9:  {"name": "🔮 Хрустальный шар",      "price": 500,  "desc": "Случайное предсказание",                        "rarity": "rare",      "category": "special",   "usable": True,  "passive": False},
    10: {"name": "🎩 Магическая шляпа",     "price": 1000, "desc": "Рандомный предмет раз в 24ч",                   "rarity": "rare",      "category": "passive",   "usable": False, "passive": True},
    11: {"name": "🐉 Яйцо дракона",         "price": 2500, "desc": "Вылупляется через 7 дней → редкий приз",        "rarity": "epic",      "category": "special",   "usable": True,  "passive": False},
    12: {"name": "👑 Корона",               "price": 5000, "desc": "+50 XP, статус «Властелин» в топе",             "rarity": "legendary", "category": "passive",   "usable": False, "passive": True},
    13: {"name": "🦊 Лисий хвост",          "price": 0,    "desc": "Редкий предмет. Награда за достижение.",        "rarity": "epic",      "category": "special",   "usable": False, "passive": True},
    14: {"name": "🎯 Амулет дуэлянта",      "price": 180,  "desc": "+1 к инициативе в следующей дуэли",             "rarity": "uncommon",  "category": "duel",      "usable": True,  "passive": False, "effect_key": "duel_roll_bonus",  "effect_value": 1,    "duration_hours": 24, "uses": 1},
    15: {"name": "🗡️ Клык берсерка",       "price": 420,  "desc": "+2 к инициативе в следующей дуэли",             "rarity": "rare",      "category": "duel",      "usable": True,  "passive": False, "effect_key": "duel_roll_bonus",  "effect_value": 2,    "duration_hours": 24, "uses": 1},
    16: {"name": "✨ Порошок удачи",        "price": 260,  "desc": "+15% удачи в /slots на 3 запуска",             "rarity": "rare",      "category": "slots",     "usable": True,  "passive": False, "effect_key": "slots_bonus",      "effect_value": 0.15, "duration_hours": 24, "uses": 3},
    17: {"name": "💰 Мешочек монет",        "price": 140,  "desc": "Открывается на 60-180 монет",                   "rarity": "uncommon",  "category": "economy",   "usable": True,  "passive": False},
    18: {"name": "🍖 Сытный паёк",          "price": 90,   "desc": "+25 XP при использовании",                     "rarity": "common",    "category": "xp",        "usable": True,  "passive": False},
    19: {"name": "🧪 Нестабильное зелье",   "price": 200,  "desc": "50%: +120 монет, 50%: +70 XP",                 "rarity": "rare",      "category": "special",   "usable": True,  "passive": False},
    20: {"name": "🩹 Боевой бинт",         "price": 240,  "desc": "+20 HP к следующей дуэли",                       "rarity": "uncommon",  "category": "duel",      "usable": True,  "passive": False, "effect_key": "duel_hp_bonus",      "effect_value": 20,   "duration_hours": 24, "uses": 1},
    21: {"name": "🛡️ Щит стаи",           "price": 260,  "desc": "-15% входящего урона в следующей дуэли",         "rarity": "rare",      "category": "duel",      "usable": True,  "passive": False, "effect_key": "duel_defense_bonus", "effect_value": 0.15, "duration_hours": 24, "uses": 1},
    22: {"name": "🔥 Руна ярости",         "price": 300,  "desc": "+4 к урону в следующей дуэли",                  "rarity": "rare",      "category": "duel",      "usable": True,  "passive": False, "effect_key": "duel_damage_bonus",  "effect_value": 4,    "duration_hours": 24, "uses": 1},
}

RARITY_META = {
    "common":    {"label": "Обычный",     "emoji": "⚪"},
    "uncommon":  {"label": "Необычный",   "emoji": "🟢"},
    "rare":      {"label": "Редкий",      "emoji": "🔵"},
    "epic":      {"label": "Эпический",   "emoji": "🟣"},
    "legendary": {"label": "Легендарный", "emoji": "🟡"},
}
...
def rarity_badge(item: dict) -> str:
    meta = RARITY_META.get(item.get("rarity", "common"), RARITY_META["common"])
    return f"{meta['emoji']} {meta['label']}"


def category_label(item: dict) -> str:
    return CATEGORY_META.get(item.get("category", "special"), "Особый")


def hat_drop_pool() -> list[int]:
    return [item_id for item_id in SHOP_ITEMS if item_id not in {12, 13}]
...
DAILY_QUEST_POOL = [
    {"key": "daily_rp_5", "title": "Сделай 5 РП-действий", "event": "rp_action", "target": 5, "reward_coins": 160, "reward_xp": 20, "reward_item_chance": 0.12, "reward_item_pool": [3, 6, 17, 18]},
    {"key": "daily_games_3", "title": "Сыграй 3 игры", "event": "play_game", "target": 3, "reward_coins": 170, "reward_xp": 20, "reward_item_chance": 0.12, "reward_item_pool": [3, 6, 17, 18]},
    {"key": "daily_use_item_1", "title": "Используй 1 предмет", "event": "use_item", "target": 1, "reward_coins": 140, "reward_xp": 18, "reward_item_chance": 0.18, "reward_item_pool": [3, 6, 17, 18]},
    {"key": "daily_buy_item_1", "title": "Купи 1 предмет", "event": "buy_item", "target": 1, "reward_coins": 150, "reward_xp": 18, "reward_item_chance": 0.14, "reward_item_pool": [3, 17, 18]},
    {"key": "daily_win_duel_1", "title": "Победи в 1 дуэли", "event": "win_duel", "target": 1, "reward_coins": 240, "reward_xp": 35, "reward_item_chance": 0.20, "reward_item_pool": [14, 16, 17, 20]},
    {"key": "daily_quiz_correct_1", "title": "Ответь верно на 1 вопрос", "event": "quiz_correct", "target": 1, "reward_coins": 160, "reward_xp": 22, "reward_item_chance": 0.12, "reward_item_pool": [3, 6, 7, 18]},
    {"key": "daily_give_200", "title": "Подари 200 монет", "event": "give_money", "target": 200, "reward_coins": 200, "reward_xp": 20, "reward_item_chance": 0.15, "reward_item_pool": [3, 17, 18]},
]

WEEKLY_QUEST_POOL = [
    {"key": "weekly_rp_30", "title": "Сделай 30 РП-действий", "event": "rp_action", "target": 30, "reward_coins": 650, "reward_xp": 80, "reward_item_chance": 0.35, "reward_item_pool": [14, 15, 16, 17, 18, 20]},
    {"key": "weekly_games_15", "title": "Сыграй 15 игр", "event": "play_game", "target": 15, "reward_coins": 700, "reward_xp": 85, "reward_item_chance": 0.35, "reward_item_pool": [14, 16, 17, 18, 19, 20]},
    {"key": "weekly_use_item_5", "title": "Используй 5 предметов", "event": "use_item", "target": 5, "reward_coins": 750, "reward_xp": 90, "reward_item_chance": 0.40, "reward_item_pool": [14, 15, 16, 19, 20, 21]},
    {"key": "weekly_buy_item_3", "title": "Купи 3 предмета", "event": "buy_item", "target": 3, "reward_coins": 700, "reward_xp": 80, "reward_item_chance": 0.35, "reward_item_pool": [14, 16, 17, 18, 20]},
    {"key": "weekly_win_duel_3", "title": "Победи в 3 дуэлях", "event": "win_duel", "target": 3, "reward_coins": 950, "reward_xp": 120, "reward_item_chance": 0.50, "reward_item_pool": [15, 16, 20, 21, 22]},
    {"key": "weekly_quiz_correct_5", "title": "Ответь верно на 5 вопросов", "event": "quiz_correct", "target": 5, "reward_coins": 720, "reward_xp": 90, "reward_item_chance": 0.35, "reward_item_pool": [7, 9, 16, 18, 19]},
    {"key": "weekly_give_1000", "title": "Подари 1000 монет", "event": "give_money", "target": 1000, "reward_coins": 900, "reward_xp": 100, "reward_item_chance": 0.45, "reward_item_pool": [14, 17, 18, 20, 21]},
]
