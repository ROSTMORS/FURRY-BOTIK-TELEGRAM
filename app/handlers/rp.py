...
NSFW_TEXTS = [
    "жадно прижал к себе и овладел",
    "схватил за волосы и взял силой",
    "раздвинул ноги и вошел без слов",
    "бросил на кровать и жестко отодрал",
    "загнал в угол и взял так, как хотел",
    "нагнул над столом и не щадил",
    "задрал юбку и вошел сзади, не спрашивая",
]
