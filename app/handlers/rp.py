...
RP_ACTIONS = {
    "трахнуть":        ("трахает",            "🥵", ["с силой", "загнав в угол", "схватив за волосы"]),
    "выебать":         ("выебал",             "👀", ["страсно", "безжалостно"]),
    "отдаться":        ("отдаётся",           "😳", ["с доверием", "раздвинув ноги"]),
    "засосать":        ("засасывает",         "🫦", ["страстно", "прижимая к себе", "жадно", "неистово"]),
