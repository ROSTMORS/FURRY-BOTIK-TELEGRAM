...
async def _apply_item_effect(message: Message, item_id: int) -> Optional[str]:
    ...
    if item_id in {14, 15, 16}:
        ...
        if item_id == 14:
            return "🎯 Амулет дуэлянта активирован! В следующей дуэли ваш бросок будет сильнее на <b>+1</b>."
        if item_id == 15:
            return "🗡️ Клык берсерка активирован! В следующей дуэли ваш бросок будет сильнее на <b>+2</b>."
