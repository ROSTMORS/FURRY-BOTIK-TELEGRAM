...
def init_db():
    ...
    c.executescript("""
        ...
        -- Активные квесты пользователя (ежедневные и недельные)
        CREATE TABLE IF NOT EXISTS user_quests (
            ...
            reward_item_chance REAL DEFAULT 0,
            reward_item_pool TEXT DEFAULT '',
            created_at INTEGER DEFAULT 0,
            UNIQUE(user_id, quest_key, quest_type, period_id)
        );
    """)
